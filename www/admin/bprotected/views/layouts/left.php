        ...
        Nav::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => '<span class="fa fa-dashboard"></span> Categories', 'url' => ['/category']],
                    ['label' => '<span class="fa fa-dashboard"></span> Menus', 'url' => ['/menu']],
                    ['label' => '<span class="fa fa-dashboard"></span> Articles', 'url' => ['/article']],
                ],
            ]
        );
        ?>
